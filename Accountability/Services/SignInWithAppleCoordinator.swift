...
//  Accountability
//
//  Created by Christopher Grayston on 8/6/20.
...
extension SignInWithAppleCoordinator: ASAuthorizationControllerDelegate {
    ...
    func authorizationController(controller: ASAuthorizationController, didCompleteWithAuthorization authorization: ASAuthorization) {
        if let appleIDCredential = authorization.credential as? ASAuthorizationAppleIDCredential {
            ...
            // Leaving this code as reference to how I had linking enabled
...
//                        print("Signing in with updated credentials")
            ...
            Auth.auth().signIn(with: credential) { (authResult, error) in
                if let error = error {
                    ...
                    case AuthErrorCode.credentialAlreadyInUse.rawValue:
                        print("TODO: This is how to handle errors. There are a lot to choose from")
                    default:
                        break
                    }
                ...
                if let isNewUser = authResult?.additionalUserInfo?.isNewUser, isNewUser {
                    // TODO: Create Firebase entry with new user
